...
class ParseArguments:
	...
	def parse():
		...
		parser.add_argument('--keys-file', type=str, default='', help='Path to prod.keys or keys.txt to use instead of the default lookup locations.')
		...
		parser.add_argument('--low-verbose', action='store_true', default=False, help='Only output progress and high-level status messages.')
